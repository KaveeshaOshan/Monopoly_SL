...
void initialize_board(Square gameboard[40]) {
    ...
    strcpy(gameboard[12].name, "Ceylon Electricity Board");
    gameboard[12].Data.utility.purchase_price = 1500;
    gameboard[12].Data.utility.mortgage_value = 750;
    gameboard[12].Data.utility.current_market_value = 1500;
    ...
    gameboard[28].Data.utility.purchase_price = 1500;
    gameboard[28].Data.utility.mortgage_value = 750;
    gameboard[28].Data.utility.current_market_value = 1500;
